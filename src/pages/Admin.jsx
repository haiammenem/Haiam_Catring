...
export default function Admin() {
  ...
  const handleAddItem = async (e) => {
    ...
    if (error) alert(error.message);
      ...
      setNewItem({ en: '', ar: '', price: '', tag: '', category: CATEGORIES[0], image: '', description: '' });
      fetchMenuItems();
    }
  };
          ...
          <div className="lg:col-span-4">
            <div className="bg-white p-8 rounded-[2rem] shadow-xl shadow-stone-200/40 border border-stone-100 sticky top-32">
              ...
              <form onSubmit={handleAddItem} className="space-y-5">
                ...
                <button 
                  type="submit"
                  className="w-full bg-amber-900 hover:bg-stone-900 text-white py-4 rounded-xl font-black text-[10px] uppercase tracking-[0.2em] transition-all flex items-center justify-center gap-2"
                >
          ...
          <div className="relative bg-white w-full max-w-2xl rounded-[3rem] p-12 overflow-y-auto max-h-[90vh]">
            ...
            <form onSubmit={handleUpdateItem} className="space-y-6">
              ...
              <div className="flex gap-4">
                <button 
                  type="submit"
                  className="flex-grow bg-amber-900 text-white py-5 rounded-2xl font-black text-xs uppercase tracking-widest"
                >
                  Save Changes
                </button>
                <button 
                  ...
                  className="px-8 bg-stone-100 text-stone-900 py-5 rounded-2xl font-black text-xs uppercase tracking-widest"
                >
                  Cancel
                </button>
              </div>
